...
The standalone repo exposes `mm` and `monarch`:
...
- **Upstream Base Library**: [hammem/monarchmoney](https://github.com/hammem/monarchmoney)
- **Standalone Repo**: [lukeslp/cli-monarch](https://github.com/lukeslp/cli-monarch)
